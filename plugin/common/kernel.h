...
nmsInferenceLandmark(cudaStream_t stream, int N, int boxesSize, int scoresSize,
             ...
             float scoreThreshold, float iouThreshold, nvinfer1::DataType DT_BBOX,
             const void *locData, nvinfer1::DataType DT_SCORE, const void *confData,
...
pluginStatus_t gatherTopDetections(cudaStream_t stream, bool shareLocation, int numImages, int numPredsPerClass,
    int numClasses, int topK, int keepTopK, nvinfer1::DataType DT_BBOX, nvinfer1::DataType DT_SCORE, const void* indices,
...
size_t detectionForwardBBoxPermuteSize(bool shareLocation, int N, int C1, nvinfer1::DataType DT_BBOX);

size_t detectionForwardLandmarkDataSize(int N, int C3, nvinfer1::DataType DT_BBOX);
